...
def DNS_Server_2 ():
	...
	#first, the DNS server has to load information from the PROJ2-DNSTS2.txt
	...
	f_input = open("PROJ2-DNSTS2.txt", "r")
	...
	try:
        	t2Socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
...
if __name__ == "__main__":
    ...
    #Initiate a thread that will run the DNS_Server_2() function
    t1 = threading.Thread(name='DNS_Server_2', target=DNS_Server_2)
    t1.start()
